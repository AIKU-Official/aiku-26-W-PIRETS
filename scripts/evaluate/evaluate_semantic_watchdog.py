...
# 20초 동안 터미널 출력이 없으면 프로세스가 죽은 것으로 간주
TIMEOUT_SECONDS = 20
...
def main():
    print("=" * 60)
    print("[Watchdog] Guardian System Activated (Semantic Mode)")
    print("=" * 60)
    ...
    # Target script: evaluate_semantic.py
    cmd = [sys.executable, "-u", "evaluate_semantic.py"] + filtered_args + [f"hydra.run.dir={fixed_output_dir}"]
