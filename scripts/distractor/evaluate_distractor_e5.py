...
def main() -> None:
    ...
    logger.info("Loading E5 encoder model: %s (device=%s)", args.model_name, device)
    ...
    out_root = Path("outputs") / f"e5_eval_{now}"
    ...
    logger.info("Saved E5 distractor outputs to %s", out_root)
