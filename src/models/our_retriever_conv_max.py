...
class OurRetrieverConvMax(nn.Module, RetrievalModel):
    ...
    def encode(self, input_ids, attention_mask):
        ...
        #  [추가] Conv1d 적용 (N-gram Feature 추출)
        # (1) 차원 뒤집기: [B, L, D] -> [B, D, L] (Conv1d 입력 형식)
        ...
        if self.config.get('use_pooler', False):
            ...
            embeddings = self._max_pooling(token_embeddings, attention_mask)
